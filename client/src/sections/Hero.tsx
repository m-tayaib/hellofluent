        ...
        <section className="md:min-h-[50vh] px-8 md:px-16 py-6">
            <div className="grid grid-cols-1 md:grid-cols-2 items-center justify-center  ">
                ...
                <div className="md:order-1  order-2 text-center md:text-left">
                    ...
                    <Link
                        to="/languages"
                        className="py-3 px-6 rounded-lg mt-2 bg-white/70 text-primary font-semibold shadow-lg hover:bg-primary hover:text-white transition-colors duration-300 ease-in-out cursor-pointer backdrop-blur-sm border border-primary/20 inline-block"
                    >
                        Start Learning
                    </Link>
                </div>
